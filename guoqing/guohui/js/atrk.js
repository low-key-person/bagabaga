! function () {
    var t = {
        ...
        params: {
            ...
            java_enabled: function () {
                return navigator && void 0 !== navigator.javaEnabled ? navigator.javaEnabled() ? "1" : "0" : ""
            },
            cookie_enabled: function () {
                return navigator && void 0 !== navigator.cookieEnabled ? navigator.cookieEnabled ? "1" : "0" : ""
            },
            ref_url: function () {
                return "string" == typeof document.referrer ? t.ue(document.referrer) : ""
            },
            host_url: function () {
                return "string" == typeof window.location.href ? t.ue(window.location.href) : ""
            },
            ...
            domain: function () {
                return "string" == typeof this.opts.domain ? this.opts.domain : ""
            },
            account: function () {
                return "string" == typeof this.opts.atrk_acct ? this.opts.atrk_acct : ""
            },
            jsv: function () {
                return this.ver
            },
        ...
        frame: function (t, n) {
            ...
            try {
                return window.document.getElementsByTagName("body")[0][n]
            } catch (t) {
                return "-"
            }
        },
        ...
        gc: function (t, n, e, r) {
            ...
            return null != o && 0 != o.length || (o = n, i = 1), this.sbc(t, o, r), o + "&" + e + "_flag=" + i
        },
        ue: function (t) {
            try {
        ...
        gbc: function (t) {
            var n, e = document.cookie,
                r = t + "=",
                o = e.indexOf("; " + r);
            if (-1 == o) {
                if (0 != (o = e.indexOf(r))) return null
            } else o += 2;
            return -1 == (n = e.indexOf(";", o)) && (n = e.length), this.ue(e.substring(o + r.length, n))
        },
        sbc: function (t, n, e) {
            var r = new Date,
                o = this.dom();
            r.setTime(r.getTime() + 1e3 * e), document.cookie = t + "=" + escape(n) + (e ? "; expires=" + r.toGMTString() : "") + (o && o.length > 0 ? "; domain=." + o : "") + "; path=/"
        },
        dom: function () {
        ...
        gen_url: function () {
            try {
                var t = this;
                return this.iu + this.map(this.params, function (n, e) {
                    return n + "=" + e.call(t)
                }).join("&")
            } catch (t) {
                return this.iu
        ...
        cloudfront: {
            ...
            fire: function () {
                "http:" == location.protocol && ((new Image).src = t.cloudfront.url)
            }
        },
        user_cookie_v: "",
        fire: function (t) {
            if (this.user_cookie_v = this.muc(), this.map(t, function (t, n) {
                    this.opts[t] = n
                }), this.opt_out_setup(), !this.opted_out() && !this.fired()) {
    ...
    window.atrk = function () {
        t.fire(_atrk_opts)
    }, "undefined" != typeof _atrk_opts && void 0 !== _atrk_opts.dynamic && _atrk_opts.dynamic && atrk()
}();